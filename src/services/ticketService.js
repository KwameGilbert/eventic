...
const ticketService = {
     ...
     * @param {string} ticketTypeData.name - Ticket type name
     * @param {string} [ticketTypeData.description] - Description
     * @param {number} ticketTypeData.price - Ticket price
     * @param {number} ticketTypeData.quantity - Available quantity
     * @param {number} ticketTypeData.event_id - Associated event ID
     * @param {string} [ticketTypeData.sale_start] - Sale start date
     * @param {string} [ticketTypeData.sale_end] - Sale end date
