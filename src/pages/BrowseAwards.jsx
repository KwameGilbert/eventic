...
const BrowseAwards = () => {
    ...
    const fetchAwards = useCallback(async (filters = {}, page = 1) => {
        setIsLoading(true);
        setError(null);
                            ...
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <input
                                        ...
                                        onKeyDown={(e) => e.key === 'Enter' && handleFilterChange(currentFilters)}
                        ...
                        {!isLoading && !error && awards.length > 0 && (
                            <>
                                <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6' : 'space-y-4'}>
                                    {awards.map((award) => (
                                        <AwardCard key={award.id} award={award} viewMode={viewMode} />
                                    ))}
                                </div>
