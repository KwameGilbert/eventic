...
const CreateAward = () => {
  ...
  const handleSubmit = async (status = "draft") => {
    ...
    try {
      ...
      if (isAdmin && awardData.organizer_id) {
        formData.append("organizer_id", awardData.organizer_id);
      }
      ...
      if (response.success) {
        ...
        setTimeout(() => {
          ...
          if (isAdmin) {
            navigate(awardId ? `/admin/awards/${awardId}` : "/admin/awards");
          } else {
            navigate(
              awardId ? `/organizer/awards/${awardId}` : "/organizer/awards",
            );
          }
        }, 1000);
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={() =>
            navigate(isAdmin ? "/admin/awards" : "/organizer/awards")
          }
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Fill in the details to create your award
          </p>
        </div>
      </div>
                ...
                {isAdmin && (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Assign Organizer <span className="text-red-500">*</span>
                    </label>
                    <select
                      name="organizer_id"
                      value={awardData.organizer_id}
