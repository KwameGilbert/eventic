        ...
        const fetchAward = async () => {
            try {
                ...
                if (response.success && response.data) {
                    ...
                    // Parse voting dates
                    const votingStart = award.voting_start ? new Date(award.voting_start).toISOString().slice(0, 16) : '';
                    const votingEnd = award.voting_end ? new Date(award.voting_end).toISOString().slice(0, 16) : '';
                ...
                setLoadError(err.message || 'An error occurred while loading award details');
            } finally {
                setIsLoading(false);
            }
        };
