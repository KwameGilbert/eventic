...
const AdminAwards = () => {
  ...
  const handleToggleFeatured = async (awardId, currentStatus) => {
    try {
      setProcessingActions((prev) => ({
        ...prev,
        [`feature-${awardId}`]: true,
      }));
      const response = await adminService.toggleAwardFeatured(
        awardId,
        !currentStatus,
      );
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4 mb-2">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            {award.award_code && (
                              <span className="text-[10px] font-mono bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded uppercase">
                                {award.award_code}
                              </span>
                            )}
                            {award.is_featured && (
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            handleToggleFeatured(award.id, award.is_featured)
                          }
                        ...
                        >
                          ...
                          <span className="hidden md:inline">
                            {award.is_featured ? "Unfeature" : "Feature"}
                          </span>
                        </Button>
                        ...
                        <select
                          value={award.status}
                          onChange={(e) =>
                            handleChangeStatus(award.id, e.target.value)
                          }
