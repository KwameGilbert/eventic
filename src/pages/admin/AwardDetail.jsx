        ...
        try {
            ...
            if (response.success) {
                ...
                setFormData({
                    ...
                    instagram: awardData.instagram || (awardData.socialMedia?.instagram) || '',
            ...
            {activeTab === 'overview' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-900">{award?.venue_name || 'Not specified'}</p>
                                            <p className="text-sm text-gray-500">{award?.address}</p>
                                            <p className="text-sm text-gray-500">{award?.city}{award?.region ? `, ${award.region}` : ''}, {award?.country}</p>
                                        </div>
                                    </div>
                                    {(award?.address || award?.city || award?.map_url) && (
                                        <div className="w-full h-40 rounded-lg overflow-hidden border border-gray-200 bg-gray-50 mt-1">
                                            <iframe
                                                src={getGoogleMapsEmbedUrl(award.map_url, award.address, award.city)}
                        ...
                        {/* Contact & Links */}
                        {(award?.phone || award?.website || award?.facebook || award?.twitter || award?.instagram || award?.video_url) && (
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    {award?.website && (
                                        <a href={award.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-blue-600 hover:underline">
                                            <Globe size={14} />
                                            Website
                                        </a>
                                    )}
                                    <div className="flex gap-3 pt-1">
                                        {award?.facebook && (
                                            <a href={award.facebook} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                                <Facebook size={16} className="text-blue-600" />
                                            </a>
                                        )}
                                        {award?.twitter && (
                                            <a href={award.twitter} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                                <Twitter size={16} className="text-blue-400" />
                                            </a>
                                        )}
                                        {award?.instagram && (
                                            <a href={award.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                                <Instagram size={16} className="text-pink-600" />
                                            </a>
                                        )}
                                    </div>
                                    {award?.video_url && (
                                        <a href={award.video_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-red-600 hover:underline pt-1">
                                            <Video size={14} />
                                            Watch Video
                                        </a>
                                    )}
                    ...
                    {award?.categories && award.categories.length > 0 ? (
                        award.categories.map((category) => (
                            <Card 
                                ...
                                className={draggedCategory?.id === category.id ? 'opacity-50' : ''}
                            >
                                <CardHeader
                                        ...
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                {category.description && (
                                                    <p className="text-sm text-gray-500 mt-1 truncate max-w-md">{category.description}</p>
                                                )}
                                            </div>
                                        </div>
                                ...
                                {expandedCategories[category.id] && (
                                    <CardContent>
                                        <div className="flex justify-between items-center mb-4 pb-2 border-b">
                                            <h4 className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Nominees</h4>
                                            <Button
                                                size="sm"
                                                variant="outline"
                                        ...
                                        {category.nominees && category.nominees.length > 0 ? (
                                                ...
                                                <table className="w-full">
                                                    <thead>
                                                        <tr className="border-b border-gray-200">
                                                            <th className="text-left py-3 px-4 font-medium text-gray-600 text-xs uppercase">#</th>
                                                            <th className="text-left py-3 px-4 font-medium text-gray-600 text-xs uppercase">Nominee</th>
                                                            <th className="text-right py-3 px-4 font-medium text-gray-600 text-xs uppercase">Votes</th>
                                                            <th className="text-right py-3 px-4 font-medium text-gray-600 text-xs uppercase">Revenue</th>
                                                            <th className="text-right py-3 px-4 font-medium text-gray-600 text-xs uppercase">%</th>
                                                            <th className="text-right py-3 px-4 font-medium text-gray-600 text-xs uppercase w-20">Actions</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {category.nominees
                                                            ...
                                                            .map((nominee, index) => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <td className="py-3 px-4 text-gray-500 text-sm font-mono">{index + 1}</td>
                                                                        <td className="py-3 px-4">
                                                                            <div className="flex items-center gap-3">
                                                                                ...
                                                                                <div className="min-w-0">
                                                                                    <p className="font-medium text-gray-900 text-sm truncate">{nominee.name}</p>
                                                                                    {nominee.nominee_code && (
                                                                                        <p className="text-[10px] text-orange-600 font-bold font-mono">CODE: {nominee.nominee_code}</p>
                                                                                    )}
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td className="text-right py-3 px-4 font-semibold text-sm">{nominee.total_votes || 0}</td>
                                                                        ...
                                                                        <td className="text-right py-3 px-4">
                                                                            <div className="flex items-center justify-end gap-2">
                                                                                ...
                                                                                <span className="text-xs font-medium">{votePercentage.toFixed(0)}%</span>
                                                                            </div>
                                                                        </td>
                                                                        <td className="text-right py-3 px-4">
                                                                            <div className="flex items-center justify-end gap-1">
                                                                                <Button
                                                                                    ...
                                                                                    variant="ghost"
                                                                                    className="h-7 w-7"
                                                                                    onClick={(e) => openNomineeModal(e, category.id, nominee)}
                                                                                >
                                                                                ...
                                                                                <Button
                                                                                    ...
                                                                                    onClick={(e) => handleDeleteNominee(e, nominee.id)}
                                                                                >
                                                                                    <Trash2 size={12} />
                                                                                </Button>
                                                                            </div>
                                            ...
                                            <div className="text-center py-8 border-2 border-dashed border-gray-100 rounded-lg bg-gray-50">
                                                ...
                                                <p className="text-gray-500 text-sm font-medium">No nominees yet</p>
                                                <Button
                                                    size="sm"
                                                    variant="ghost"
                        ...
                        <Card>
                            <CardContent className="text-center py-16 flex flex-col items-center justify-center">
                                ...
                                <h4 className="text-lg font-semibold text-gray-900 mb-1">No Categories Found</h4>
                                <p className="text-gray-500 max-w-sm mb-6">Start by adding categories and nominees for this award.</p>
                                <Button
                                    className="gap-2"
                                    onClick={() => openCategoryModal()}
                                >
                            ...
                            <div>
                                <label className="flex items-center gap-3 cursor-pointer">
                                    <input
                                        ...
                                        className="w-5 h-5 text-orange-600 border-gray-300 rounded focus:ring-orange-500"
                                    />
                                    <span className="text-sm font-medium text-gray-700">Show Results Publicly</span>
                                </label>
                                <p className="text-xs text-gray-500 mt-1 ml-8">If enabled, vote counts will be visible to the public</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                {award?.nominees_count > 0 && (
                                    <p className="text-xs text-red-500 mt-1">
                                        Award code cannot be changed because this award already has nominees.
                                    </p>
                                )}
