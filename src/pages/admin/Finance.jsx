...
import PayoutDetailModal from "../../components/admin/finance/PayoutDetailModal";
import PayoutRejectionModal from "../../components/admin/finance/PayoutRejectionModal";
import {
  BarChart,
  Bar,
  XAxis,
...
const AdminFinance = () => {
  ...
  const tabs = [
    ...
    { id: "revenue", label: "Revenue Analytics", icon: BarChart3 },
    {
      ...
      icon: Wallet,
      count: financeData?.payouts?.pending_count || 0,
    },
  ];
  ...
  const handleRejectPayout = async () => {
    ...
    try {
      setProcessingPayouts((prev) => ({
        ...prev,
        [rejectionModal.payoutId]: "rejecting",
      }));
      const response = await adminService.rejectPayout(
        rejectionModal.payoutId,
        rejectionReason,
      );
  ...
  const handleViewDetails = async (payoutId) => {
    try {
      setDetailModal({ isOpen: true, payoutId, data: null, isLoading: true });
      const response = await adminService.getPayout(payoutId);
      if (response.success) {
        setDetailModal((prev) => ({
          ...prev,
        ...
        showError(response.message || "Failed to fetch payout details");
        setDetailModal({
          isOpen: false,
          payoutId: null,
          data: null,
      ...
      showError(err.message || "Failed to fetch payout details");
      setDetailModal({
        isOpen: false,
        payoutId: null,
        data: null,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Platform revenue, analytics, and payout management
          </p>
        </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  >
                    {Math.abs(summary.monthly_growth_percent || 0)}% vs last
                    month
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-yellow-600 font-medium mt-1">
                  {adminService.formatCurrency(payoutData.pending_amount || 0)}{" "}
                  awaiting
                </p>
              </div>
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <RechartsPie>
                      ...
                      <Tooltip
                        formatter={(value) =>
                          adminService.formatCurrency(value)
                        }
                      />
                    </RechartsPie>
                  </ResponsiveContainer>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex justify-between items-center p-2 bg-red-50 rounded-lg">
                  ...
                  <span className="font-semibold text-gray-900">
                    {adminService.formatCurrency(
                      revenueBreakdown.tickets?.gross_revenue || 0,
                    )}
                  </span>
                </div>
                <div className="flex justify-between items-center p-2 bg-orange-50 rounded-lg">
                  ...
                  <span className="font-semibold text-gray-900">
                    {adminService.formatCurrency(
                      revenueBreakdown.votes?.gross_revenue || 0,
                    )}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gradient-to-br from-green-50 to-green-100/50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-green-900">
                    {transactions.total_tickets_sold || 0}
                  </p>
                </div>
                <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-purple-900">
                    {transactions.total_votes?.toLocaleString() || 0}
                  </p>
                </div>
                <div className="p-4 bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-orange-900">
                    {transactions.total_vote_transactions || 0}
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="flex justify-between items-center p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <div>
                    ...
                    <p className="text-xl font-bold text-yellow-900">
                      {adminService.formatCurrency(
                        organizerBalances.total_pending || 0,
                      )}
                    </p>
                  </div>
                ...
                <div className="flex justify-between items-center p-4 bg-green-50 rounded-xl border border-green-200">
                  <div>
                    ...
                    <p className="text-xl font-bold text-green-900">
                      {adminService.formatCurrency(
                        organizerBalances.total_available || 0,
                      )}
                    </p>
                  </div>
                ...
                <div className="flex justify-between items-center p-4 bg-blue-50 rounded-xl border border-blue-200">
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-900">
                      {adminService.formatCurrency(
                        organizerBalances.total_withdrawn || 0,
                      )}
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">
                          {adminService.formatCurrency(event.total_revenue)}
                        </p>
                        <p className="text-xs text-green-600">
                          +{adminService.formatCurrency(event.platform_fees)}{" "}
                          fees
                        </p>
                      </div>
                    </div>
                  ...
                  {topAwards.map((award, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {award.total_votes?.toLocaleString()} votes
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">
                          {adminService.formatCurrency(award.total_revenue)}
                        </p>
                        <p className="text-xs text-green-600">
                          +{adminService.formatCurrency(award.platform_fees)}{" "}
                          fees
                        </p>
                      </div>
                    </div>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={monthlyTrend}>
                    ...
                    />
                    <Tooltip
                      formatter={(value) => adminService.formatCurrency(value)}
                    />
                    <Legend />
                    <Bar
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between p-3 bg-green-50 rounded-lg">
                ...
                <span className="font-semibold text-green-700">
                  {adminService.formatCurrency(
                    revenueBreakdown.tickets?.platform_fees || 0,
                  )}
                </span>
              </div>
              <div className="flex justify-between p-3 bg-blue-50 rounded-lg">
                ...
                <span className="font-semibold text-blue-700">
                  {adminService.formatCurrency(
                    revenueBreakdown.tickets?.organizer_share || 0,
                  )}
                </span>
              </div>
              <div className="flex justify-between p-3 bg-purple-50 rounded-lg">
                ...
                <span className="font-semibold text-purple-700">
                  {revenueBreakdown.tickets?.percentage || 0}%
                </span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="col-span-12 lg:col-span-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between p-3 bg-green-50 rounded-lg">
                ...
                <span className="font-semibold text-green-700">
                  {adminService.formatCurrency(
                    revenueBreakdown.votes?.platform_fees || 0,
                  )}
                </span>
              </div>
              <div className="flex justify-between p-3 bg-blue-50 rounded-lg">
                ...
                <span className="font-semibold text-blue-700">
                  {adminService.formatCurrency(
                    revenueBreakdown.votes?.organizer_share || 0,
                  )}
                </span>
              </div>
              <div className="flex justify-between p-3 bg-purple-50 rounded-lg">
                <span className="text-purple-700">Revenue Share</span>
                <span className="font-semibold text-purple-700">
                  {revenueBreakdown.votes?.percentage || 0}%
                </span>
              </div>
            </CardContent>
          </Card>
      ...
      <PayoutRejectionModal
        ...
        payoutId={rejectionModal.payoutId}
