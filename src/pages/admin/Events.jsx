...
const AdminEvents = () => {
  ...
  const handleToggleFeatured = async (eventId, currentStatus) => {
    try {
      setProcessingActions((prev) => ({
        ...prev,
        [`feature-${eventId}`]: true,
      }));
      const response = await adminService.toggleEventFeatured(
        eventId,
        !currentStatus,
      );
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <select
                          value={event.status}
                          onChange={(e) =>
                            handleChangeStatus(event.id, e.target.value)
                          }
