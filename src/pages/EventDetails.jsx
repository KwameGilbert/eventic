  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <SEO
        ...
        description={
          event.description ||
          `Get tickets for ${event.title} at ${event.venue}. Event date: ${event.date}.`
        }
        image={event.image}
        type="article"
      />
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {event.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full font-semibold text-sm"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="space-y-3">
                    {(event.contact?.email || event.email) && (
                      <div className="flex items-center gap-3 text-gray-700">
                        ...
                        <a
                          href={`mailto:${event.contact?.email || event.email}`}
                    ...
                    {(event.contact?.phone || event.phone) && (
                      <div className="flex items-center gap-3 text-gray-700">
                        ...
                        <a
                          href={`tel:${event.contact?.phone || event.phone}`}
                          className="hover:text-(--brand-primary) hover:underline"
                        >
                          {event.contact?.phone || event.phone}
                        </a>
                    ...
                    {(event.contact?.website || event.website) && (
                      <div className="flex items-center gap-3 text-gray-700">
                        ...
                        <a
                          href={event.contact?.website || event.website}
                          target="_blank"
                ...
                {event.ticketTypes && event.ticketTypes.length > 0 ? (
                  <div className="space-y-3 mb-6">
                    {event.ticketTypes.map((ticket, index) => (
                      <div
                        key={ticket.id || index}
                        className={`p-4 rounded-lg border-2 ${ticket.availableQuantity > 0 ? "border-(--brand-primary) bg-(--brand-primary)/5" : "border-gray-300 bg-gray-50"}`}
                      >
                        {/* Ticket Image */}
                        {ticket.ticketImage && (
                          <img
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <img
                      src={
                        ...
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(event.organizer.name)}&background=ff6b35&color=fff`
                      }
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {event.organizer.eventsOrganized || 0} events organized
                      </p>
                    </div>
                  </div>
