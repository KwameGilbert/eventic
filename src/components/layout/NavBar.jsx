              ...
              <div className="flex lg:hidden items-center gap-2">
                {isAuthenticated() ? (
                  ...
                  <>
                    <Link
                      to="/signin"
                      className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-all hover:scale-105 active:scale-95"
                    >
                ...
                >
                  <div
                    className={`transition-transform duration-200 ${isMobileMenuOpen ? "rotate-90" : "rotate-0"}`}
                  >
